  ...
  const MediaMonitor = () => (
    <div>
      <div className="w-90 mx-5" style={{marginTop: '140px'}}>
        ...
        <p>Media monitoring helps you to stay up-to-date with the latest trends without using up too much of your resources. We collected 6 reasons why you should get started with media monitoring.</p>

        <h2>1. Build a&nbsp;strong brand</h2>
        <p>Media monitoring helps you to see what people think about your brand. Are they aware that your brand exists? Do they understand what your brand is about? Media monitoring enables you to spot any misconceptions so you can take action to correct them.</p>
        <p>It will also help you notice any pitfalls in your communications.&nbsp;Check that your brand's tone of voice is consistent when publishing blog articles or social media posts. This way you have the strongest chance of connecting with your target customers.</p>
        ...
        <p><img alt="" src="../src/images/media-monitoring-2.png"/></p>
        ...
        <p>Media monitoring is a simple way to find out about the latest developments in your industry: recognize future trends and predict possible spikes in demand for your products and services. When you see what&rsquo;s coming, you can plan your strategy in advance and take actions immediately when it&rsquo;s timely.</p>
        <p>Media monitoring also lets you discover who your competitors are. Follow what they are doing and analyze their actions. This way you can avoid repeating the mistakes your competitors are doing, but also develop the areas in which your competitors do better.</p>
        ...
        <p><img src="../src/images/media-monitoring-3.jpg" alt=""/></p>
        ...
        <p>As any marketing and comms pro knows, it&rsquo;s important to create fresh content constantly. Yet, we tend to find ourselves in the same spot time and time again: "I have no idea what to write about."</p>
        <p>Media monitoring helps you stay inspired. Set up a monitor of your industry to see what topics are trending on a general level. If you already have a topic in your mind, try following related keywords. This way you will find new creative ideas and angles for your content. You can also use your opponents&rsquo; ideas as a source for inspiration or as a warning for what doesn&rsquo;t work. Data is your best friend when brainstorming for content ideas. Find out more about <a href="https://www.lianatech.com/blog/how-to-master-the-art-of-data-driven-pr.html">how to master the art of data-driven PR</a>.</p>
        <p><em>Feeling that you need a hand with getting started? Our team of experts is ready to help you find the ideal media monitoring and communications solution for your business.<a href="https://www.lianatech.com/contact-us.html"> Request a call back</a> and we will contact you!</em></p>
        <p><em>This article was originally published on April 21st, 2016 and updated on December 12th, 2018.</em></p>
        <br /><br />
      </div>
      <Footer/>
    </div>
